...
# period
execute if score time_s internal matches 250 if score period internal matches 0 run worldborder set 20 3600
execute if score time_s internal matches 300 if score period internal matches 0 run function vip:main_game

execute if score time_s internal matches 900 if score period internal matches 1 run worldborder set 20 2100
...
execute if score period internal matches 0 run bossbar set vip:main max 300
